...
def find_awards(data, awards):
    ...
    for award in awards:
        ...
        likely_awards = [chunk.text for seq in tagged_text for chunk in seq.ents if chunk.label_ in allowed_labels ]
        counter = Counter(likely_awards)
        awards[award] = [item[0] for item in counter.most_common(5)]
