...
def backward_check_for_names_from_index(start_index, t_split, dense_t_split, tl_split_lower, award_dict, matched_award):
...
def backward_check_for_names(tl_split_lower, t_split, award_dict, matched_award, dense_t_split, keyword):
        ...
        if ("amp" in bef_keyword_lower and bef_keyword_lower.index("amp") <= name1_index - 2):
            name_2_index = bef_keyword_lower.index("amp")
        if ("and" in bef_keyword_lower and bef_keyword_lower.index("and") <= name1_index - 2):
